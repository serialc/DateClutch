...
class Poll
{
    ...
    public static function listForUser( $uid )
    {
        ...
        foreach ($polls as $poll) {
            ...
            echo ' <a href="#/" class="ms-2" title="Delete poll" data-bs-toggle="modal" data-bs-target="#mainModal" action="delete_poll" pid="' . $poll['pid'] . '" poll_title="' . $poll['title'] . '"><i class="fa fa-trash accent3" aria-hidden="true"></i></a></p>';
        }
        echo '</div></div>';
    }
    ...
    public function displayResponsesEditing ()
    {
        ...
        foreach($this->dates as $date => $clutcher) {
            ...
            echo '<a href="#/" title="Delete date" data-bs-toggle="modal" data-bs-target="#mainModal" action="delete_date" pid="' . $this->pid . '" date="' . $clean_date . '"><i class="fa fa-trash accent3" aria-hidden="true"></i></a> ' . $clean_date . '<br>';

            if(!empty($clutcher)) {
                echo '<span id="clutcher_' . $clean_date . '"><a href="#/" title="Erase clutcher" data-bs-toggle="modal" data-bs-target="#mainModal" action="delete_clutcher" pid="' . $this->pid . '" date="' . $clean_date . '" clutcher="' . $clutcher . '"><i class="fa fa-eraser accent3" aria-hidden="true"></i></a> ' . $clutcher . '</span>';
            }
            echo '</div></div>';
        }
        echo '</div>';
